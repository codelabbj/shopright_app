...
class PluginsDrawerWidget extends StatefulWidget {
  const PluginsDrawerWidget({super.key});

  @override
  State<PluginsDrawerWidget> createState() => _PluginsDrawerWidgetState();
}

class _PluginsDrawerWidgetState extends State<PluginsDrawerWidget> {
          ...
          children: [
            InkWell(
              ...
              child: Container(
                ...
                child: TextButton(
                  onPressed: () {
                    if (state.selectedPage == 12 || isExpanded) {
                      setState(() {
                        isExpanded = false;
                      });
                    } else {
