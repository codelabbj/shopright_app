...
class SystemAdminWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final tiles = <_SysTileData>[
      _SysTileData('Users', 'View and update your system users', Icons.people_outline),
      _SysTileData('Roles And Permissions', 'View and update your roles and permissions', Icons.verified_user_outlined),
      _SysTileData('Request Logs', 'View and delete your system request logs', Icons.receipt_long_outlined),
      ...
      _SysTileData('Cache Management', 'Clear cache to make your site up to date.', Icons.cached_outlined),
...
class _SysTileData {
  ...
  final IconData icon;
  const _SysTileData(this.title, this.subtitle, this.icon);
}
