...
import '../widgets/create_blog_tag_widget.dart';

class CreateBlogTagScreen extends StatelessWidget {
  const CreateBlogTagScreen({super.key});
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text('Blog / Tags / Create', style: Theme.of(context).textTheme.displaySmall!.copyWith(fontWeight: FontWeight.bold)),
                      ],
                    ),
                  ),
                  Expanded(
                    child: SingleChildScrollView(
                      ...
                      child: Row(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          const Expanded(flex: 3, child: CreateBlogTagWidget()),
