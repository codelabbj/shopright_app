...
import '../widgets/blog_tags_widget.dart';
import 'package:go_router/go_router.dart';

class BlogTagsScreen extends StatefulWidget {
  const BlogTagsScreen({super.key});

  @override
  State<BlogTagsScreen> createState() => _BlogTagsScreenState();
}

class _BlogTagsScreenState extends State<BlogTagsScreen> {
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text("Blog / Tags", style: Theme.of(context).textTheme.displaySmall!.copyWith(fontWeight: FontWeight.bold)),
                      ],
                    ),
                  ),
                  Expanded(
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: CardListWidget(
                              ...
                              actions: [
                                InkWell(
                                  onTap: () => context.go('/blog/tags/create'),
                                  child: Container(
                                    padding: const EdgeInsets.all(10),
                                    decoration: BoxDecoration(border: Border.all(color: Colors.grey[200]!), borderRadius: BorderRadius.circular(5)),
                                    child: Row(children: [
