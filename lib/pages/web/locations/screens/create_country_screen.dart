...
import '../widgets/create_country_widget.dart';

class CreateCountryScreen extends StatelessWidget {
  const CreateCountryScreen({super.key});
            ...
            child: Column(children: [
              ...
              Padding(
                ...
                child: Row(children: [
                  ...
                  Text('Locations / Countries / New Country',
              ...
              Expanded(
                child: Padding(
                  ...
                  child: SingleChildScrollView(child: const CreateCountryWidget()),
                ),
              ),
            ]),
          ),
