...
import '../widgets/settings_general_widget.dart';
            ...
            child: Column(children: [
              ...
              Padding(
                ...
                child: Row(children: [
                  ...
                  Text('Settings / General', style: Theme.of(context).textTheme.displaySmall!.copyWith(fontWeight: FontWeight.bold)),
                ]),
              ),
              Expanded(
                child: Padding(
                  padding: const EdgeInsets.all(12.0),
                  child: SingleChildScrollView(child: const SettingsGeneralWidget()),
                ),
              ),
            ]),
          ),
