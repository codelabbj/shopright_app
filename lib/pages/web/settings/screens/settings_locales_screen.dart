...
import '../widgets/settings_locales_widget.dart';

class SettingsLocalesScreen extends StatelessWidget {
  const SettingsLocalesScreen({super.key});
            ...
            child: Column(children: [
              ...
              Padding(
                ...
                child: Row(children: [
                  ...
                  Text('Settings / Localization / Locales', style: Theme.of(context).textTheme.displaySmall!.copyWith(fontWeight: FontWeight.bold)),
                ]),
              ),
              Expanded(
                child: Padding(
                  padding: const EdgeInsets.all(12.0),
                  child: SingleChildScrollView(child: const SettingsLocalesWidget()),
                ),
              ),
            ]),
          ),
