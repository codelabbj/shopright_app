...
class MarketMessaesScreen extends StatefulWidget {
  ...
  @override
  State<MarketMessaesScreen> createState() => _MarketMessaesScreenState();
}

class _MarketMessaesScreenState extends State<MarketMessaesScreen> {
