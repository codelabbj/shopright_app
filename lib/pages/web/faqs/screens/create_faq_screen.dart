...
import '../widgets/create_faq_widget.dart';
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text('FAQs / Create', style: Theme.of(context).textTheme.displaySmall!.copyWith(fontWeight: FontWeight.bold)),
                      ],
                    ),
                  ),
                  Expanded(
                    child: SingleChildScrollView(
                      ...
                      child: Row(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          const Expanded(flex: 3, child: CreateFaqWidget()),
