...
import '../widets/create_product_group_widget.dart';

class CreateProductGroupScreen extends StatefulWidget {
  const CreateProductGroupScreen({super.key});

  @override
  State<CreateProductGroupScreen> createState() => _CreateProductGroupScreenState();
}

class _CreateProductGroupScreenState extends State<CreateProductGroupScreen> {
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text('Specification Groups / Create',
                        ...
                        if (constraints.maxWidth > 1024) {
                          ...
                          return SingleChildScrollView(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                const CreateProductGroupWidget(),
                                const SizedBox(height: 12),
                                Container(
                                  padding: const EdgeInsets.all(20),
                                  decoration: BoxDecoration(
