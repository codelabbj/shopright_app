...
class PagesTabWidget extends StatefulWidget {
  const PagesTabWidget({Key? key}) : super(key: key);

  @override
  State<PagesTabWidget> createState() => _PagesTabWidgetState();
}

class _PagesTabWidgetState extends State<PagesTabWidget> {
  List<PageItemModel> items = [
    ...
    PageItemModel(id: 2, name: "New Day", status: "Not Published", templates: 'Default', createdAt: '2025-08-08'),
    PageItemModel(id: 3, name: "Happy Day", status: "Published", templates: 'Full width', createdAt: '2025-08-08'),
    PageItemModel(id: 4, name: "Nature", status: "Deleted", templates: 'Default', createdAt: '2025-08-08'),
    PageItemModel(id: 5, name: "Morning", status: "Published", templates: 'Without Layout', createdAt: '2025-08-08'),
  ];
  ...
  Widget build(BuildContext context) {
    return DataTable(
      ...
      columns: [
        ...
        DataColumn(label: Text("Templates")),
      ...
      rows: List.generate(items.length, (index) {
        ...
        return DataRow(
          ...
          cells: [
            ...
            DataCell(Text(item.templates, style: Theme.of(context).textTheme.labelSmall)),
