...
import '../widgets/galleries_widget.dart';

class GalleriesSceen extends StatefulWidget {
  const GalleriesSceen({super.key});

  @override
  State<GalleriesSceen> createState() => _GalleriesSceenState();
}

class _GalleriesSceenState extends State<GalleriesSceen> {
