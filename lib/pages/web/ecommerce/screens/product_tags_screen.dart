...
class ProductTagsScreen extends StatefulWidget {
  const ProductTagsScreen({super.key});

  @override
  State<ProductTagsScreen> createState() => _ProductTagsScreenState();
}

class _ProductTagsScreenState extends State<ProductTagsScreen> {
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text('Ecommerce / Product Tags', style: Theme.of(context).textTheme.displaySmall!.copyWith(fontWeight: FontWeight.bold)),
                      ],
                    ),
                  ),
                  Expanded(
                          ...
                          SizedBox(
                            ...
                            child: CardListWidget(
                              ...
                              actions: [
                                InkWell(
                                  onTap: () {
                                    context.go('/ecommerce/product-tags/create');
                                  },
                                  child: Container(
                                    padding: EdgeInsets.all(10),
                                    decoration: BoxDecoration(
