...
class TestimonalsScreen extends StatefulWidget {
  const TestimonalsScreen({super.key});

  @override
  State<TestimonalsScreen> createState() => _TestimonalsScreenState();
}

class _TestimonalsScreenState extends State<TestimonalsScreen> {
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text("Testimonials", style: Theme.of(context).textTheme.displaySmall!.copyWith(fontWeight: FontWeight.bold)),
                      ],
                    ),
                  ),
                  Expanded(
