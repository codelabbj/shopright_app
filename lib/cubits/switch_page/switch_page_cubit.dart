...
class SwitchPageCubit extends Cubit<SwitchPageState> {
  ...
  void switchPage(double pageIndex) {
    emit(state.copyWith(
        ...
        isLocationExpanded: (pageIndex == 8.1 || pageIndex == 8.2 || pageIndex == 8.3 || pageIndex == 8.4 || pageIndex == 8.5),
        isToolExpanded: (pageIndex == 8.9)));
  ...
  void setLocationExpanded(bool isExpanded) {
    emit(state.copyWith(isLocationExpanded: isExpanded));
  }
  ...
  void setToolExpanded(bool isExpanded) {
    emit(state.copyWith(isToolExpanded: isExpanded));
  }
